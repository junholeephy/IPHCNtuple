{
    ...
    TH1F*  hist0 = (TH1F*)_file->Get("MetLD_FinalCut_WZZZ_CR__");
    hist0->Sumw2();
    ...
    TH1F*  hist1 = (TH1F*)_file01->Get("MetLD_FinalCut_WZZZ_CR__");
    hist1->Sumw2();

    TFile *_file02 ;
    _file02 = TFile::Open("./Input/output_DY1_MC.root");
    _file02->cd();

    TH1F*  hist2 = (TH1F*)_file02->Get("MetLD_FinalCut_WZZZ_CR__");
    hist2->Sumw2();
    ...
    TH1F*  histData = (TH1F*)_file1->Get("MetLD_FinalCut_WZZZ_CR__");
    histData->Sumw2();
