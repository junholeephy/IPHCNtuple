{
    ...
    _fileWZ->cd();
    TH1F*  histWZ = (TH1F*)_fileWZ->Get("MinMll_AN_finalSel_WZ_CR__");
    histWZ->Sumw2();
    histWZ->SetFillColor(kMagenta-6);
    histWZ->SetLineColor(kMagenta-6);
 
    _fileZZ->cd();
    TH1F*  histZZ = (TH1F*)_fileZZ->Get("MinMll_AN_finalSel_WZ_CR__");
    histZZ->Sumw2();
    histZZ->SetFillColor(kAzure+6);
    histZZ->SetLineColor(kAzure+6);
 
    _fileDY->cd();
    TH1F*  histDY = (TH1F*)_fileDY->Get("MinMll_AN_finalSel_WZ_CR__");
    histDY->Sumw2();
    ...
    _fileTTZ->cd();
    TH1F*  histTTZ = (TH1F*)_fileTTZ->Get("MinMll_AN_finalSel_WZ_CR__");
    histTTZ->Sumw2();
    histTTZ->SetFillColor(kAzure+6);
    histTTZ->SetLineColor(kAzure+6);
 
   // _fileZZZ->cd();
   // TH1F*  histZZZ = (TH1F*)_fileZZZ->Get("MinMll_AN_finalSel_WZ_CR__");
    //histZZZ->Sumw2();

    _fileWWZ->cd();
    TH1F*  histWWZ = (TH1F*)_fileWWZ->Get("MinMll_AN_finalSel_WZ_CR__");
    histWWZ->Sumw2();
    ...
    _fileDATA->cd();
    TH1F*  histData = (TH1F*)_fileDATA->Get("MinMll_AN_finalSel_WZ_CR__");
    histData->Sumw2();
    histData->SetMarkerStyle(20);

    histWZ->Scale(0.96);
    
    TH1F*  histDataFake = (TH1F*)_fileDATA->Get("MinMll_AN_Fakes_finalSel_WZ_CR__");
    histDataFake->Sumw2();
    ...
    histData->GetXaxis()->SetTitle("M(ll)_{min} in 3l + 2 non-b jets");
