{
    ...
    TH1F*  histWZ = (TH1F*)_fileWZ->Get("ZCandidateInvariantMass_FinalCut_WZZZ_CR__");
    histWZ->Sumw2();
    ...
    TH1F*  histZZ = (TH1F*)_fileZZ->Get("ZCandidateInvariantMass_FinalCut_WZZZ_CR__");
    histZZ->Sumw2();

    // DY
    TFile *_fileDY ;
    _fileDY = TFile::Open("./Input/output_DY1_MC.root");
    _fileDY->cd();

    TH1F*  histDY = (TH1F*)_fileDY->Get("ZCandidateInvariantMass_FinalCut_WZZZ_CR__");
    histDY->Sumw2();
    ...
    TH1F*  histTTZ = (TH1F*)_fileTTZ->Get("ZCandidateInvariantMass_FinalCut_WZZZ_CR__");
    histTTZ->Sumw2();
    ...
    TH1F*  histZZZ = (TH1F*)_fileZZZ->Get("ZCandidateInvariantMass_FinalCut_WZZZ_CR__");
    histZZZ->Sumw2();
    ...
    TH1F*  histWWZ = (TH1F*)_fileWWZ->Get("ZCandidateInvariantMass_FinalCut_WZZZ_CR__");
    histWWZ->Sumw2();
    ...
    TH1F*  histData = (TH1F*)_fileDATA->Get("ZCandidateInvariantMass_FinalCut_WZZZ_CR__");
