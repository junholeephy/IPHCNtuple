...
#include <iostream> 
#include <iomanip> 
#include "Parameters_sm_ggtt.h"

// Initialize static instance
Parameters_sm_ggtt * Parameters_sm_ggtt::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_ggtt * Parameters_sm_ggtt::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_ggtt(); 

  return instance; 
}

void Parameters_sm_ggtt::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_ggtt::setIndependentCouplings()
{

}
void Parameters_sm_ggtt::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_ggtt::setDependentCouplings()
{
...
void Parameters_sm_ggtt::printIndependentParameters()
{
...
void Parameters_sm_ggtt::printIndependentCouplings()
{
  cout <<  "sm model couplings independent of event kinematics:" << endl; 

}
void Parameters_sm_ggtt::printDependentParameters()
{
...
void Parameters_sm_ggtt::printDependentCouplings()
{
