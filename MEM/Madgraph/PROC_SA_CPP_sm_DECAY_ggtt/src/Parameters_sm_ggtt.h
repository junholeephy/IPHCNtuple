...
#ifndef Parameters_sm_ggtt_H
#define Parameters_sm_ggtt_H
...
class Parameters_sm_ggtt
{
  public:

    static Parameters_sm_ggtt * getInstance(); 
  ...
  private:
    static Parameters_sm_ggtt * instance; 
}; 

#endif  // Parameters_sm_ggtt_H
