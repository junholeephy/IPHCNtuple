...
#ifndef HelAmps_sm_no_b_mass_ppthq_H
#define HelAmps_sm_no_b_mass_ppthq_H
...
namespace MG5_sm_no_b_mass_ppthq 
{
...
}  // end namespace MG5_sm_no_b_mass_ppthq

#endif  // HelAmps_sm_no_b_mass_ppthq_H
