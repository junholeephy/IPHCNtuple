...
#include <iostream> 
#include <iomanip> 
#include "Parameters_sm_no_b_mass_ppthq.h"

// Initialize static instance
Parameters_sm_no_b_mass_ppthq * Parameters_sm_no_b_mass_ppthq::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_no_b_mass_ppthq * Parameters_sm_no_b_mass_ppthq::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_no_b_mass_ppthq(); 

  return instance; 
}

void Parameters_sm_no_b_mass_ppthq::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_no_b_mass_ppthq::setIndependentCouplings()
{
...
void Parameters_sm_no_b_mass_ppthq::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_no_b_mass_ppthq::setDependentCouplings()
{

}

// Routines for printing out parameters
void Parameters_sm_no_b_mass_ppthq::printIndependentParameters()
{
...
void Parameters_sm_no_b_mass_ppthq::printIndependentCouplings()
{
...
void Parameters_sm_no_b_mass_ppthq::printDependentParameters()
{
...
void Parameters_sm_no_b_mass_ppthq::printDependentCouplings()
{
