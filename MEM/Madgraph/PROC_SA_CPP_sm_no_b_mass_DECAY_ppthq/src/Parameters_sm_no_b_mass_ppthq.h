...
#ifndef Parameters_sm_no_b_mass_ppthq_H
#define Parameters_sm_no_b_mass_ppthq_H
...
class Parameters_sm_no_b_mass_ppthq
{
  public:

    static Parameters_sm_no_b_mass_ppthq * getInstance(); 
  ...
  private:
    static Parameters_sm_no_b_mass_ppthq * instance; 
}; 

#endif  // Parameters_sm_no_b_mass_ppthq_H
