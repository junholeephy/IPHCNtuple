...
#ifndef Parameters_sm_ckm_qqttlmvl_H
#define Parameters_sm_ckm_qqttlmvl_H
...
class Parameters_sm_ckm_qqttlmvl
{
  public:

    static Parameters_sm_ckm_qqttlmvl * getInstance(); 
  ...
  private:
    static Parameters_sm_ckm_qqttlmvl * instance; 
}; 

#endif  // Parameters_sm_ckm_qqttlmvl_H
