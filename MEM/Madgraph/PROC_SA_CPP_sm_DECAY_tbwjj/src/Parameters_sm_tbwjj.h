...
#ifndef Parameters_sm_tbwjj_H
#define Parameters_sm_tbwjj_H
...
class Parameters_sm_tbwjj
{
  public:

    static Parameters_sm_tbwjj * getInstance(); 
  ...
  private:
    static Parameters_sm_tbwjj * instance; 
}; 

#endif  // Parameters_sm_tbwjj_H
