...
#ifndef Parameters_sm_ckm_ppttlpvljj_H
#define Parameters_sm_ckm_ppttlpvljj_H
...
class Parameters_sm_ckm_ppttlpvljj
{
  public:

    static Parameters_sm_ckm_ppttlpvljj * getInstance(); 
  ...
  private:
    static Parameters_sm_ckm_ppttlpvljj * instance; 
}; 

#endif  // Parameters_sm_ckm_ppttlpvljj_H
