...
#ifndef Parameters_sm_ggttll_H
#define Parameters_sm_ggttll_H
...
class Parameters_sm_ggttll
{
  public:

    static Parameters_sm_ggttll * getInstance(); 
  ...
  private:
    static Parameters_sm_ggttll * instance; 
}; 

#endif  // Parameters_sm_ggttll_H
