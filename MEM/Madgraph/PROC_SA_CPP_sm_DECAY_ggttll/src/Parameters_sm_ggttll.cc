...
Parameters_sm_ggttll * Parameters_sm_ggttll::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_ggttll * Parameters_sm_ggttll::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_ggttll(); 

  return instance; 
}

void Parameters_sm_ggttll::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_ggttll::setIndependentCouplings()
{
...
void Parameters_sm_ggttll::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_ggttll::setDependentCouplings()
{
...
void Parameters_sm_ggttll::printIndependentParameters()
{
...
void Parameters_sm_ggttll::printIndependentCouplings()
{
...
void Parameters_sm_ggttll::printDependentParameters()
{
...
void Parameters_sm_ggttll::printDependentCouplings()
{
