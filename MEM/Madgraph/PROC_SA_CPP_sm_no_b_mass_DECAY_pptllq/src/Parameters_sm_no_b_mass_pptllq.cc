...
Parameters_sm_no_b_mass_pptllq * Parameters_sm_no_b_mass_pptllq::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_no_b_mass_pptllq * Parameters_sm_no_b_mass_pptllq::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_no_b_mass_pptllq(); 

  return instance; 
}

void Parameters_sm_no_b_mass_pptllq::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_no_b_mass_pptllq::setIndependentCouplings()
{
...
void Parameters_sm_no_b_mass_pptllq::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_no_b_mass_pptllq::setDependentCouplings()
{

}

// Routines for printing out parameters
void Parameters_sm_no_b_mass_pptllq::printIndependentParameters()
{
...
void Parameters_sm_no_b_mass_pptllq::printIndependentCouplings()
{
...
void Parameters_sm_no_b_mass_pptllq::printDependentParameters()
{
...
void Parameters_sm_no_b_mass_pptllq::printDependentCouplings()
{
