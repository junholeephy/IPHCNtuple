...
#ifndef MG5_Sigma_sm_uux_ttxh_H
#define MG5_Sigma_sm_uux_ttxh_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "u u~ > t t~ h (sm)";}
