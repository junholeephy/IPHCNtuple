...
#include "CPPProcess_qqttlpvl.h"
#include "HelAmps_sm_qqttlpvl.h"

using namespace MG5_sm_qqttlpvl; 
...
void CPPProcess_qqttlpvl::initProc(string param_card_name) 
{
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_sm_qqttlpvl::getInstance(); 
...
void CPPProcess_qqttlpvl::sigmaKin() 
{
...
double CPPProcess_qqttlpvl::sigmaHat() 
{
...
void CPPProcess_qqttlpvl::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3(w[4], w[5], pars->GC_100, pars->mdl_MW, pars->mdl_WW, w[7]); 
...
double CPPProcess_qqttlpvl::matrix_udx_ttxepve() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 
