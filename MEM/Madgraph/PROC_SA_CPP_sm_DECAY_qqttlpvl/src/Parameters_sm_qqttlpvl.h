...
#ifndef Parameters_sm_qqttlpvl_H
#define Parameters_sm_qqttlpvl_H
...
class Parameters_sm_qqttlpvl
{
  public:

    static Parameters_sm_qqttlpvl * getInstance(); 
  ...
  private:
    static Parameters_sm_qqttlpvl * instance; 
}; 

#endif  // Parameters_sm_qqttlpvl_H
