...
#include <iostream> 
#include <iomanip> 
#include "Parameters_sm_qqttlpvl.h"

// Initialize static instance
Parameters_sm_qqttlpvl * Parameters_sm_qqttlpvl::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_qqttlpvl * Parameters_sm_qqttlpvl::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_qqttlpvl(); 

  return instance; 
}

void Parameters_sm_qqttlpvl::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_qqttlpvl::setIndependentCouplings()
{
  GC_100 = (mdl_ee * mdl_complexi * mdl_conjg__CKM1x1)/(mdl_sw * mdl_sqrt__2); 
}
void Parameters_sm_qqttlpvl::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_qqttlpvl::setDependentCouplings()
{
  GC_11 = mdl_complexi * G; 
}

// Routines for printing out parameters
void Parameters_sm_qqttlpvl::printIndependentParameters()
{
...
void Parameters_sm_qqttlpvl::printDependentCouplings()
{
