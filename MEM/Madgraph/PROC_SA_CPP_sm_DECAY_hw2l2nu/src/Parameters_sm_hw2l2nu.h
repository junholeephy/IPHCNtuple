...
#ifndef Parameters_sm_hw2l2nu_H
#define Parameters_sm_hw2l2nu_H
...
class Parameters_sm_hw2l2nu
{
  public:

    static Parameters_sm_hw2l2nu * getInstance(); 
    ...
    std::complex<double> GC_72, GC_100; 
  ...
  private:
    static Parameters_sm_hw2l2nu * instance; 
}; 
