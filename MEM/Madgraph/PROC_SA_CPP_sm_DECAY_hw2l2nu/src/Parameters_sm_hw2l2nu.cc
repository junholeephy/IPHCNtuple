...
#include <iostream> 
#include <iomanip> 
#include "Parameters_sm_hw2l2nu.h"

// Initialize static instance
Parameters_sm_hw2l2nu * Parameters_sm_hw2l2nu::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_hw2l2nu * Parameters_sm_hw2l2nu::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_hw2l2nu(); 

  return instance; 
}

void Parameters_sm_hw2l2nu::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_hw2l2nu::setIndependentCouplings()
{
...
void Parameters_sm_hw2l2nu::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_hw2l2nu::setDependentCouplings()
{

}

// Routines for printing out parameters
void Parameters_sm_hw2l2nu::printIndependentParameters()
{
...
void Parameters_sm_hw2l2nu::printIndependentCouplings()
{
...
void Parameters_sm_hw2l2nu::printDependentParameters()
{
...
void Parameters_sm_hw2l2nu::printDependentCouplings()
{
