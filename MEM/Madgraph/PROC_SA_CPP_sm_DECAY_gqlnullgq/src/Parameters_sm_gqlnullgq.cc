...
Parameters_sm_gqlnullgq * Parameters_sm_gqlnullgq::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_gqlnullgq * Parameters_sm_gqlnullgq::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_gqlnullgq(); 

  return instance; 
}

void Parameters_sm_gqlnullgq::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_gqlnullgq::setIndependentCouplings()
{
...
void Parameters_sm_gqlnullgq::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_gqlnullgq::setDependentCouplings()
{
...
void Parameters_sm_gqlnullgq::printIndependentParameters()
{
...
void Parameters_sm_gqlnullgq::printIndependentCouplings()
{
...
void Parameters_sm_gqlnullgq::printDependentParameters()
{
...
void Parameters_sm_gqlnullgq::printDependentCouplings()
{
