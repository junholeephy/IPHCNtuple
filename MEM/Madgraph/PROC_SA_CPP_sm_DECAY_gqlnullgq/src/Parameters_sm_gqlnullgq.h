...
#ifndef Parameters_sm_gqlnullgq_H
#define Parameters_sm_gqlnullgq_H
...
class Parameters_sm_gqlnullgq
{
  public:

    static Parameters_sm_gqlnullgq * getInstance(); 
  ...
  private:
    static Parameters_sm_gqlnullgq * instance; 
}; 

#endif  // Parameters_sm_gqlnullgq_H
