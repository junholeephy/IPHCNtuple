...
#ifndef Parameters_sm_antitbwjj_H
#define Parameters_sm_antitbwjj_H
...
class Parameters_sm_antitbwjj
{
  public:

    static Parameters_sm_antitbwjj * getInstance(); 
  ...
  private:
    static Parameters_sm_antitbwjj * instance; 
}; 
