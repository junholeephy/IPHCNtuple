...
#include <iostream> 
#include <iomanip> 
#include "Parameters_sm_antitbwjj.h"

// Initialize static instance
Parameters_sm_antitbwjj * Parameters_sm_antitbwjj::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_antitbwjj * Parameters_sm_antitbwjj::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_antitbwjj(); 

  return instance; 
}

void Parameters_sm_antitbwjj::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_antitbwjj::setIndependentCouplings()
{
  GC_100 = (mdl_ee * mdl_complexi * mdl_conjg__CKM1x1)/(mdl_sw * mdl_sqrt__2); 
}
void Parameters_sm_antitbwjj::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_antitbwjj::setDependentCouplings()
{

}

// Routines for printing out parameters
void Parameters_sm_antitbwjj::printIndependentParameters()
{
...
void Parameters_sm_antitbwjj::printIndependentCouplings()
{
  cout <<  "sm model couplings independent of event kinematics:" << endl; 
  cout << setw(20) <<  "GC_100 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_100 << endl;
}
void Parameters_sm_antitbwjj::printDependentParameters()
{
...
void Parameters_sm_antitbwjj::printDependentCouplings()
{
