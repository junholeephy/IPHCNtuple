...
#include "HelAmps_sm_ckm_ppttlmvljj.h"
#include <complex> 
#include <cmath> 
#include <iostream> 
#include <cstdlib> 
...
namespace MG5_sm_ckm_ppttlmvljj 
{
    ...
    V4[], complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  P1[2] = -V1[1].imag(); 
  P1[3] = -V1[0].imag(); 
  TMP7 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]); 
  TMP8 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]); 
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V3[2] * TMP7) + cI * (V2[2] * TMP8)); 
  V1[3] = denom * (-cI * (V3[3] * TMP7) + cI * (V2[3] * TMP8)); 
  V1[4] = denom * (-cI * (V3[4] * TMP7) + cI * (V2[4] * TMP8)); 
  V1[5] = denom * (-cI * (V3[5] * TMP7) + cI * (V2[5] * TMP8)); 
}
    ...
    V4[], complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (TMP4 * V4[2]) + cI * (V2[2] * TMP8)); 
  V1[3] = denom * (-cI * (TMP4 * V4[3]) + cI * (V2[3] * TMP8)); 
  V1[4] = denom * (-cI * (TMP4 * V4[4]) + cI * (V2[4] * TMP8)); 
  V1[5] = denom * (-cI * (TMP4 * V4[5]) + cI * (V2[5] * TMP8)); 
}
    ...
    V4[], complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (TMP4 * V4[2]) + cI * (V3[2] * TMP7)); 
  V1[3] = denom * (-cI * (TMP4 * V4[3]) + cI * (V3[3] * TMP7)); 
  V1[4] = denom * (-cI * (TMP4 * V4[4]) + cI * (V3[4] * TMP7)); 
  V1[5] = denom * (-cI * (TMP4 * V4[5]) + cI * (V3[5] * TMP7)); 
}


}  // end namespace $(namespace)s_sm_ckm_ppttlmvljj
