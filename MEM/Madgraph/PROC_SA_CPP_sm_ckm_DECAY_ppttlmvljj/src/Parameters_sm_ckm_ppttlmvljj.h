...
#ifndef Parameters_sm_ckm_ppttlmvljj_H
#define Parameters_sm_ckm_ppttlmvljj_H
...
class Parameters_sm_ckm_ppttlmvljj
{
  public:

    static Parameters_sm_ckm_ppttlmvljj * getInstance(); 
  ...
  private:
    static Parameters_sm_ckm_ppttlmvljj * instance; 
}; 

#endif  // Parameters_sm_ckm_ppttlmvljj_H
