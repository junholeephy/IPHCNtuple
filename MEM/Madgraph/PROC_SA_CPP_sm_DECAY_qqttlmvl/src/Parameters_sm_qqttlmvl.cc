...
#include <iostream> 
#include <iomanip> 
#include "Parameters_sm_qqttlmvl.h"

// Initialize static instance
Parameters_sm_qqttlmvl * Parameters_sm_qqttlmvl::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_qqttlmvl * Parameters_sm_qqttlmvl::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_qqttlmvl(); 

  return instance; 
}

void Parameters_sm_qqttlmvl::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_qqttlmvl::setIndependentCouplings()
{
  GC_100 = (mdl_ee * mdl_complexi * mdl_conjg__CKM1x1)/(mdl_sw * mdl_sqrt__2); 
}
void Parameters_sm_qqttlmvl::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_qqttlmvl::setDependentCouplings()
{
  GC_11 = mdl_complexi * G; 
}

// Routines for printing out parameters
void Parameters_sm_qqttlmvl::printIndependentParameters()
{
...
void Parameters_sm_qqttlmvl::printDependentCouplings()
{
