...
#ifndef Parameters_sm_qqttlmvl_H
#define Parameters_sm_qqttlmvl_H
...
class Parameters_sm_qqttlmvl
{
  public:

    static Parameters_sm_qqttlmvl * getInstance(); 
  ...
  private:
    static Parameters_sm_qqttlmvl * instance; 
}; 

#endif  // Parameters_sm_qqttlmvl_H
