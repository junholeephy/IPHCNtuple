...
#include "CPPProcess_qqttlmvl.h"
#include "HelAmps_sm_qqttlmvl.h"

using namespace MG5_sm_qqttlmvl; 
...
void CPPProcess_qqttlmvl::initProc(string param_card_name) 
{
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_sm_qqttlmvl::getInstance(); 
...
void CPPProcess_qqttlmvl::sigmaKin() 
{
...
double CPPProcess_qqttlmvl::sigmaHat() 
{
...
void CPPProcess_qqttlmvl::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3(w[5], w[4], pars->GC_100, pars->mdl_MW, pars->mdl_WW, w[7]); 
...
double CPPProcess_qqttlmvl::matrix_dux_ttxemvex() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 
